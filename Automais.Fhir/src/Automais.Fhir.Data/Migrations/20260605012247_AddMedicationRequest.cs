...
{
    /// <inheritdoc />
    public partial class AddMedicationRequest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    authored_on = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_medication_request", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_medication_request_encounter_id",
                schema: "fhir",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_medication_request_meta_source",
                schema: "fhir",
                table: "medication_request",
                column: "meta_source");

            migrationBuilder.CreateIndex(
                name: "IX_medication_request_patient_id",
                schema: "fhir",
                table: "medication_request",
                column: "patient_id",
