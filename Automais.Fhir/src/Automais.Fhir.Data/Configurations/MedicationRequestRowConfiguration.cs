...
public sealed class MedicationRequestRowConfiguration : IEntityTypeConfiguration<MedicationRequestRow>
{
    public void Configure(EntityTypeBuilder<MedicationRequestRow> builder)
    {
        builder.ToTable("medication_request");
        ...
        builder.Property(m => m.AuthoredOn).HasColumnName("authored_on");
