...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Regulacao.DocumentoRegulatorio", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Regulacao.PendenciaRegulatoria", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Regulacao.ProcessoRegulatorio", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Regulacao.ProcessoRegulatorioConfiguracao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Regulacao.ProcessoRegulatorioEvento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Tfd.MensagemWhatsApp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Tfd.TfdConfigFaturamento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Tfd.TfdConfigGoogle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Tfd.TfdConfigWhatsApp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.ComunicacaoPaciente", b =>
                {
                    ...
                    b.HasOne("SMSMarica.Data.Entities.Tfd.MensagemWhatsApp", "MensagemWhatsApp")
                        .WithMany()
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Regulacao.DocumentoRegulatorio", b =>
                {
                    ...
                    b.HasOne("SMSMarica.Data.Entities.Regulacao.PendenciaRegulatoria", "Pendencia")
                        .WithMany()
                        .HasForeignKey("PendenciaId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("SMSMarica.Data.Entities.Regulacao.ProcessoRegulatorio", "ProcessoRegulatorio")
                        .WithMany("Documentos")
                        .HasForeignKey("ProcessoRegulatorioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SMSMarica.Data.Entities.Regulacao.DocumentoRegulatorio", "SubstituiDocumento")
                        .WithMany()
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Regulacao.PendenciaRegulatoria", b =>
                {
                    b.HasOne("SMSMarica.Data.Entities.Unidade", "DestinatarioUnidade")
                        .WithMany()
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Regulacao.ProcessoRegulatorio", b =>
                {
                    ...
                    b.HasOne("SMSMarica.Data.Entities.Unidade", "UnidadeDestino")
                        .WithMany()
            ...
            modelBuilder.Entity("SMSMarica.Data.Entities.Regulacao.ProcessoRegulatorioEvento", b =>
                {
                    b.HasOne("SMSMarica.Data.Entities.Regulacao.DocumentoRegulatorio", "Documento")
                        .WithMany()
                        .HasForeignKey("DocumentoId")
                        .OnDelete(DeleteBehavior.SetNull);
