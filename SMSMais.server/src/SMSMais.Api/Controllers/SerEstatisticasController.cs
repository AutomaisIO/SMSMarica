...
/// <summary>
/// SER → <b>Estatísticas</b> do trabalho dos operadores (equipe e individual), a partir da trilha
/// de eventos da fila espelhada. Somente leitura sobre o nosso banco — nada aqui fala com o SER.
///
/// <para>Ver: <see cref="ModuloPermissao.EstatisticaSer"/>. Escolher quem entra nas estatísticas:
/// <see cref="ModuloPermissao.RegulacaoConfiguracao"/> — muda o que todos veem.</para>
/// </summary>
[ApiController]
[Route("regulacao/ser/estatisticas/operadores")]
public sealed class SerEstatisticasController(IEstatisticasOperadoresExternosService estatisticas) : ControllerBase
{
    private const FonteEstatisticaExterna Fonte = FonteEstatisticaExterna.Ser;
    ...
    [HttpGet("equipe")]
    [RequerPermissao(ModuloPermissao.EstatisticaSer, AcoesPermissao.Consulta)]
