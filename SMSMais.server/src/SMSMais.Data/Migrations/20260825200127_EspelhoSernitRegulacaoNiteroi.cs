...
{
    /// <inheritdoc />
    public partial class EspelhoSernitRegulacaoNiteroi : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "sernit_solicitacao",
                schema: "smsmarica",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    id_sernit = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sernit_solicitacao", x => x.id);
                });

            migrationBuilder.CreateTable(
                name: "sernit_varredura_execucao",
                schema: "smsmarica",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    cursor_situacao = table.Column<int>(type: "integer", nullable: true),
                    cursor_data = table.Column<DateOnly>(type: "date", nullable: true),
                    cursor_id_sernit = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    historicos_pendentes = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sernit_varredura_execucao", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    sernit_solicitacao_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sernit_evento", x => x.id);
                    table.ForeignKey(
                        name: "FK_sernit_evento_sernit_solicitacao_sernit_solicitacao_id",
                        column: x => x.sernit_solicitacao_id,
                        principalSchema: "smsmarica",
                        principalTable: "sernit_solicitacao",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sernit_gatilho", x => x.id);
                    table.ForeignKey(
                        name: "FK_sernit_gatilho_sernit_solicitacao_sernit_solicitacao_id",
                        column: x => x.sernit_solicitacao_id,
                        principalSchema: "smsmarica",
                        principalTable: "sernit_solicitacao",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_sernit = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sernit_varredura_falha", x => x.id);
                    table.ForeignKey(
                        name: "FK_sernit_varredura_falha_sernit_varredura_execucao_execucao_id",
                        column: x => x.execucao_id,
                        principalSchema: "smsmarica",
                        principalTable: "sernit_varredura_execucao",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "ix_sernit_evento_evento_capturado",
                schema: "smsmarica",
                table: "sernit_evento",
                columns: new[] { "evento", "capturado_em" });

            migrationBuilder.CreateIndex(
                name: "ix_sernit_evento_solicitacao_data",
                schema: "smsmarica",
                table: "sernit_evento",
                columns: new[] { "sernit_solicitacao_id", "data_evento" },
                descending: new[] { false, true });

            migrationBuilder.CreateIndex(
                name: "ux_sernit_evento_solicitacao_data_evento",
                schema: "smsmarica",
                table: "sernit_evento",
                columns: new[] { "sernit_solicitacao_id", "data_evento", "evento" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_sernit_gatilho_pendente",
                schema: "smsmarica",
                table: "sernit_gatilho",
                columns: new[] { "tipo", "criado_em" },
                filter: "processado_em IS NULL");

            migrationBuilder.CreateIndex(
                name: "ux_sernit_gatilho_solicitacao_tipo_chave",
                schema: "smsmarica",
                table: "sernit_gatilho",
                columns: new[] { "sernit_solicitacao_id", "tipo", "chave_evento" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_sernit_solicitacao_cns",
                schema: "smsmarica",
                table: "sernit_solicitacao",
                column: "cns");

            migrationBuilder.CreateIndex(
                name: "ix_sernit_solicitacao_cpf",
                schema: "smsmarica",
                table: "sernit_solicitacao",
                column: "cpf");

            migrationBuilder.CreateIndex(
                name: "ix_sernit_solicitacao_paciente_conciliar",
                schema: "smsmarica",
                table: "sernit_solicitacao",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_sernit_solicitacao_paciente_id",
                schema: "smsmarica",
                table: "sernit_solicitacao",
                column: "paciente_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_sernit_solicitacao_situacao_data",
                schema: "smsmarica",
                table: "sernit_solicitacao",
                columns: new[] { "situacao", "data_solicitacao" });

            migrationBuilder.CreateIndex(
                name: "ix_sernit_solicitacao_situacao_historico_lido",
                schema: "smsmarica",
                table: "sernit_solicitacao",
                columns: new[] { "situacao", "historico_lido_em" });

            migrationBuilder.CreateIndex(
                name: "ux_sernit_solicitacao_id_sernit",
                schema: "smsmarica",
                table: "sernit_solicitacao",
                column: "id_sernit",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_sernit_varredura_execucao_iniciado",
                schema: "smsmarica",
                table: "sernit_varredura_execucao",
                column: "iniciado_em",
                descending: new bool[0]);

            migrationBuilder.CreateIndex(
                name: "ix_sernit_varredura_execucao_status",
                schema: "smsmarica",
                table: "sernit_varredura_execucao",
                column: "status");

            migrationBuilder.CreateIndex(
                name: "ix_sernit_varredura_falha_execucao_tipo",
                schema: "smsmarica",
                table: "sernit_varredura_falha",
