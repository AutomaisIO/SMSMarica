...
{
    /// <inheritdoc />
    public partial class RemoveAgendaLocal : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    especialidade_id = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_agenda_recurso_por_finalidade", "(finalidade = 1 AND especialidade_id IS NOT NULL AND equipamento_id IS NULL) OR (finalidade = 2 AND equipamento_id IS NOT NULL AND especialidade_id IS NULL AND medico_id IS NULL)");
                    table.ForeignKey(
