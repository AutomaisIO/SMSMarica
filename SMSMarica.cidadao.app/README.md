...
Consome a API do **`SMSMarica.server`**. Cadastros e parametrizações feitas pelas equipes ocorrem no **`SMSMarica.front`**; o motorista opera pelo **`SMSMarica.agente.app`**.
