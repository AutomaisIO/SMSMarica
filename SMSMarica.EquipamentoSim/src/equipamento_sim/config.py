...
class Config:
    ...
    - DCM4CHEE: Storage SCP (recebe C-STORE)
    - WORKLIST: MWL/UPS SCP (responde C-FIND MWL e expõe UPS-RS)
    Não é correto usar DCM4CHEE como Called AE para C-FIND MWL — falha com
    `cannot associate`.
    """
    ...
    called_ae_mwl: str
    """AE de destino para C-FIND MWL (WORKLIST). O AE DCM4CHEE NÃO responde MWL."""
