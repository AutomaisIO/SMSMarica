...
> **Promovido em 05/09/2026**, quando o incremento 1 foi para produção. Duas coisas mudaram em
> relação ao rascunho, e as duas foram medidas, não supostas:
>
> 1. **O catálogo é plano, sem hierarquia** (decisão D-10). O balde do SERNIT
>    (`Endocrinologia`) e as subespecialidades do SER (`ENDOCRINOLOGIA - DIABETES`) são
>    procedimentos canônicos **distintos**, e a busca devolve todos; quem desempata é o agente
>    regulador, que pode trocar o procedimento na triagem. São 17 casos assim, levantados no
>    spike c.
> 2. **O embedding é só do rótulo** — sem o nome do sistema e sem o ramo. Com o sistema no texto,
>    dois recursos de nome idêntico em sistemas diferentes ficam em cosseno **0,851** contra um
>    corte de 0,85: o par que a sugestão existe para encontrar fica pendurado na fronteira.
>    Sistema e ramo continuam como colunas, que é o que basta para filtrar.
>
> Relatórios: [`SMSMais.Regulacao/revisoes/spike-c-paridade.md`](../../SMSMais.Regulacao/revisoes/spike-c-paridade.md).
