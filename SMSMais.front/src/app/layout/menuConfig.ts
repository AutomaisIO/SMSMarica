...
export const SECOES: SecaoMenu[] = [
  ...
  {
    // Ouvidoria (ADR-0060): manifestações do cidadão — fila central, registro, ponto de resposta e gestão.
    id: 'ouvidoria',
    titulo: 'Ouvidoria',
    icone: Megaphone,
    itens: [
      {
        ...
        descricao: 'Manifestações em triagem, em andamento, atrasadas, em recurso e concluídas.',
      },
      {
        rotulo: 'Registrar',
        to: '/app/ouvidoria/registrar',
        icone: FilePlus2,
        modulo: 'Ouvidoria',
        descricao: 'Registrar manifestação recebida presencialmente, por telefone, carta ou outro canal.',
      },
      {
        rotulo: 'Meu ponto',
        to: '/app/ouvidoria/meu-ponto',
        icone: Inbox,
        modulo: 'OuvidoriaPontoResposta',
        descricao: 'Manifestações encaminhadas à sua unidade ou área para responder.',
      },
      {
        rotulo: 'Pontos de resposta',
        to: '/app/ouvidoria/pontos-resposta',
        icone: Network,
        modulo: 'OuvidoriaGestao',
        descricao: 'Unidades, áreas e apuração que respondem, com seus membros.',
      },
      {
        rotulo: 'Assuntos',
        to: '/app/ouvidoria/assuntos',
        icone: Layers,
        modulo: 'OuvidoriaGestao',
        descricao: 'Assuntos em dois níveis e marcadores para classificar.',
      },
      {
        rotulo: 'Painel',
        to: '/app/ouvidoria/painel',
        icone: BarChart3,
        modulo: 'OuvidoriaGestao',
        descricao: 'Volume, prazo, tempo de resposta e resolutividade por período.',
      },
      {
        rotulo: 'Configuração',
        to: '/app/ouvidoria/configuracao',
        icone: Settings2,
        modulo: 'OuvidoriaGestao',
        descricao: 'Prazos legais e avisos por WhatsApp.',
      },
    ],
  },
  {
    ...
    titulo: 'Manual',
    icone: BookOpen,
    // Sem `modulo`: manual não se permissiona. Quem entra no painel pode aprender a usá-lo —
    // esconder a explicação de quem tem acesso à tela seria o contrário do propósito.
    itens: [
      {
        rotulo: 'Manual',
        to: '/app/manual',
        icone: BookOpen,
        descricao: 'Como usar cada tela, com simulações em que dá para clicar sem medo.',
      },
    ],
  },
  {
