        ...
        <section className="space-y-4 lg:col-span-2">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-4">
            ...
            {r.historicoIndisponivel ? (
              // Vale explicar em vez de mostrar vazio: em Alta o menu do SER não oferece o item,
              // e como Alta é estado terminal, a trilha nunca mais ficará legível lá.
              <p className="rounded bg-amber-50 p-3 text-sm text-amber-800">
                O SER não oferece o histórico desta solicitação — solicitações em Alta não têm o
