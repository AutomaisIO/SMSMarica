    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-slate-200">
        ...
        <div className="mb-1 ml-auto flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-2 py-1">
          <label htmlFor="sernit-filtro-tecnicos" className="text-xs font-semibold uppercase tracking-wide text-slate-500">
            Técnico regulador
          </label>
          <FiltroTecnicos
      ...
      <div className="flex flex-wrap items-center gap-2 text-sm">
        <label htmlFor="sernit-filtro-categoria-followup" className="text-slate-600">
          Último FollowUP:
        </label>
        <select
