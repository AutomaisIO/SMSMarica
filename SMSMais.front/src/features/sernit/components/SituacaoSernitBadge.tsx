...
import { ROTULO_SITUACAO, type SituacaoSernit } from '@/features/sernit/types';
 ...
 */
const CLASSE: Record<SituacaoSernit, string> = {
...
type Props = { situacao: SituacaoSernit; className?: string };

export function SituacaoSernitBadge({ situacao, className }: Props) {
  return (
    <span
      className={cn(
